  ...
  return (
    <div className="account-details">
      ...
      <p>
        ...
        {recovered_account_json.address}
      </p>
      <p>
        <label>PublicKey : </label> {recovered_account_json.public_key}
      </p>
      <p>
        <label>Privatekey : </label> {recovered_account_json.private_key}
      </p>
...
const RecoverAccount = () => {
  ...
  return (
    <div>
      {recovered && (
        <Recovered recovered_account_json={recovered_account_json} />
      )}
      {!recovered && (
        <Recoveryform
          mnemonic={mnemonic}
